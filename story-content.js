...
คุณอยู่ที่นี่มาทั้งชีวิต รู้ว่าช่วงบ่ายกระแสน้ำตรงไหนอุ่น รู้ว่ารากไหนเป็นที่หลบของปลาตัวเล็ก รู้แม้กระทั่งเสียงเครื่องเรือของลุงประเสริฐ — ก่อนที่เรือจะโผล่พ้นแหลมมาด้วยซ้ำ
...
ยังไม่มีอะไรเกิดขึ้น ทุกอย่างยังสมบูรณ์อยู่`,
    ...
    chapter2: {
      ...
      branch: "main",
      text: `พักหลังมานี้บทสนทนาของชาวประมงดูเปลี่ยไป จากที่ดูมีชีวิตชีวา กลับดูหม่นหมองขึ้นอย่างเห็นได้ชัด คุณว่ายเข้าไปใกล้ขึ้น
...
แผนที่แสดงเส้นตรงสีแดง เส้นที่ดูมั่นใจ หนักแน่น พาดผ่านป่าโกงกาง ไม่ได้อ้อม แต่ตัดผ่านตรง ๆ
...
ตอนแรกน้ำเปลี่ยนช้ามาก เหมือนห้องที่เปลี่ยนไปหลังจากใครบางคนที่คุณรักจากไป ไม่มีอะไรชัดเจน แสงบางอย่างที่หายไป หรือเสียงบางอย่างที่เงียบลง

แล้วทุกอย่างก็เริ่มชัดเจน`,
...
สำหรับบางคน แลนด์บริดจ์อาจหมายถึงโอกาสที่จะได้มีชีวิตอีกแบบ

แต่ในขณะเดียวกัน ก็มีหลายครอบครัวตามแนวชายฝั่งนี้

ที่รู้เรื่องน้ำขึ้นน้ำลงจนมันกลายเป็นสัญชาตญาณในร่างกาย

ที่ไม่เคยมีแผนสำรอง เพราะไม่เคยจำเป็นต้องมีมัน

แลนด์บริดจ์จะทำให้บางคนอยู่รอด และทำให้อีกบางคนต้องจากไป
